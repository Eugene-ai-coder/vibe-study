export default function CommonDtlCodeForm({ data, onChange, isEdit }) {
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
      <h2 className="text-sm font-semibold text-gray-700 mb-3">공통상세코드 정보</h2>
      <div className="grid grid-cols-6 gap-x-4 gap-y-3">
        <label className="col-span-1 flex items-center text-xs text-gray-500">상세코드</label>
        <div className="col-span-1">
          <input
            name="commonDtlCode"
            value={data.commonDtlCode || ''}
            onChange={onChange}
            readOnly={isEdit}
        ...
        <label className="col-span-1 flex items-center text-xs text-gray-500">상세코드명</label>
        <div className="col-span-1">
          <input
            name="commonDtlCodeNm"
            value={data.commonDtlCodeNm || ''}
            onChange={onChange}
            className="w-full h-8 border border-gray-300 rounded px-2 text-sm focus:outline-none focus:border-blue-400"
          />
        </div>
        <label className="col-span-1 flex items-center text-xs text-gray-500">정렬순서</label>
        <div className="col-span-1">
          <input
            type="number"
            name="sortOrder"
