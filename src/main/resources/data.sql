-- ================================================================
-- 초기 데이터 (INSERT IGNORE = 기존 데이터 보존, 신규만 삽입)
...
-- ================================================================
INSERT IGNORE INTO tb_user (user_id, nickname, password, email, account_status, created_by, created_dt) VALUES
...
-- ── 1. 공통코드 헤더 ─────────────────────────────────────────────
INSERT IGNORE INTO tb_common_code (common_code, common_code_nm, remark, created_by, created_dt) VALUES
...
INSERT IGNORE INTO tb_common_code (common_code, common_code_nm, remark, created_by, created_dt) VALUES
('basic_prod_cd', '기본상품코드', 'tb_subscription.basic_prod_cd, tb_bill_std.basic_prod_cd, tb_bill_std_req.basic_prod_cd', 'SYSTEM', CURRENT_TIMESTAMP)
...
-- 가입상태코드
INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, eff_start_dt, eff_end_dt, created_by, created_dt) VALUES
...
-- 기본상품코드
INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, eff_start_dt, eff_end_dt, created_by, created_dt) VALUES
('basic_prod_cd', 'FP_A', '요금상품 A', 1, '2000-01-01 00:00:00', '9999-12-31 23:59:59', 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, eff_start_dt, eff_end_dt, created_by, created_dt) VALUES
('basic_prod_cd', 'FP_B', '요금상품 B', 2, '2000-01-01 00:00:00', '9999-12-31 23:59:59', 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, eff_start_dt, eff_end_dt, created_by, created_dt) VALUES
('basic_prod_cd', 'FP_C', '요금상품 C', 3, '2000-01-01 00:00:00', '9999-12-31 23:59:59', 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, eff_start_dt, eff_end_dt, created_by, created_dt) VALUES
('basic_prod_cd', 'FP_D', '요금상품 D', 4, '2000-01-01 00:00:00', '9999-12-31 23:59:59', 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, eff_start_dt, eff_end_dt, created_by, created_dt) VALUES
('basic_prod_cd', 'FP_E', '요금상품 E', 5, '2000-01-01 00:00:00', '9999-12-31 23:59:59', 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, eff_start_dt, eff_end_dt, created_by, created_dt) VALUES
('basic_prod_cd', 'FP_F', '요금상품 F', 6, '2000-01-01 00:00:00', '9999-12-31 23:59:59', 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, eff_start_dt, eff_end_dt, created_by, created_dt) VALUES
('basic_prod_cd', 'PROD_A', '상품 A', 7, '2000-01-01 00:00:00', '9999-12-31 23:59:59', 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, eff_start_dt, eff_end_dt, created_by, created_dt) VALUES
('basic_prod_cd', 'PROD_B', '상품 B', 8, '2000-01-01 00:00:00', '9999-12-31 23:59:59', 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, eff_start_dt, eff_end_dt, created_by, created_dt) VALUES
('basic_prod_cd', 'PROD_C', '상품 C', 9, '2000-01-01 00:00:00', '9999-12-31 23:59:59', 'SYSTEM', CURRENT_TIMESTAMP)
...
-- ================================================================
INSERT IGNORE INTO tb_bill_std_field_config (svc_cd, field_cd, eff_start_dt, field_nm, field_type, required_yn, sort_order, common_code, default_value, eff_end_dt, created_by, created_dt) VALUES
...
-- 최상위 메뉴 (Level 1)
INSERT IGNORE INTO tb_menu (menu_id, menu_nm, menu_url, parent_menu_id, sort_order, use_yn, menu_level, created_by, created_dt) VALUES
('MNU001', 'Main', '/main', NULL, 1, 'Y', 1, 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_menu (menu_id, menu_nm, menu_url, parent_menu_id, sort_order, use_yn, menu_level, created_by, created_dt) VALUES
('MNU002', '가입관리', NULL, NULL, 3, 'Y', 1, 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_menu (menu_id, menu_nm, menu_url, parent_menu_id, sort_order, use_yn, menu_level, created_by, created_dt) VALUES
('MNU017', '워크플로우', NULL, NULL, 4, 'Y', 1, 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_menu (menu_id, menu_nm, menu_url, parent_menu_id, sort_order, use_yn, menu_level, created_by, created_dt) VALUES
('MNU007', '시스템 설정', NULL, NULL, 5, 'Y', 1, 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_menu (menu_id, menu_nm, menu_url, parent_menu_id, sort_order, use_yn, menu_level, created_by, created_dt) VALUES
('MNU011', '게시판', NULL, NULL, 6, 'Y', 1, 'SYSTEM', CURRENT_TIMESTAMP)
...
-- ================================================================
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU001', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU001', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU002', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU002', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU003', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU003', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU004', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU004', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU005', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU005', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU006', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU006', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU007', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU007', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU008', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU008', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU009', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU009', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU010', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU011', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU011', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU012', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU012', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU013', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU014', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU014', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU015', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU015', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU016', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU017', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU017', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU018', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU018', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU019', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU019', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU020', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU020', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU021', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU021', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU022', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU022', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU024', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU024', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU025', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU025', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);

-- ================================================================
-- 사용자-역할 매핑 (user01=ADMIN, 나머지=USER)
-- ================================================================
INSERT IGNORE INTO tb_user_role (user_id, role_cd, created_by, created_dt) VALUES ('user01', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_user_role (user_id, role_cd, created_by, created_dt) VALUES ('user02', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_user_role (user_id, role_cd, created_by, created_dt) VALUES ('user03', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_user_role (user_id, role_cd, created_by, created_dt) VALUES ('user04', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_user_role (user_id, role_cd, created_by, created_dt) VALUES ('user05', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_user_role (user_id, role_cd, created_by, created_dt) VALUES ('user06', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_user_role (user_id, role_cd, created_by, created_dt) VALUES ('user07', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_user_role (user_id, role_cd, created_by, created_dt) VALUES ('user08', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_user_role (user_id, role_cd, created_by, created_dt) VALUES ('user09', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_user_role (user_id, role_cd, created_by, created_dt) VALUES ('user10', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);

-- ================================================================
-- TODO 공통코드
-- ================================================================
INSERT IGNORE INTO tb_common_code (common_code, common_code_nm, created_by, created_dt) VALUES
('todo_status_cd', 'TODO상태코드', 'SYSTEM', CURRENT_TIMESTAMP)

INSERT IGNORE INTO tb_common_dtl_code (common_code, common_dtl_code, common_dtl_code_nm, sort_order, created_by, created_dt) VALUES
...
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU023', 'ADMIN', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT IGNORE INTO tb_menu_role (menu_id, role_cd, created_by, created_dt) VALUES ('MNU023', 'USER', 'SYSTEM', CURRENT_TIMESTAMP);

-- ================================================================
-- 워크플로우 엔티티 유형 정의
-- ================================================================
INSERT IGNORE INTO tb_wf_entity_type_def (entity_type_cd, entity_type_nm, table_nm, pk_column, status_column, status_cd_group, biz_key_column, biz_key_label, route_path, created_by, created_dt)
